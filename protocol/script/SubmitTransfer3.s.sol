...
contract SubmitTransfer3 is Script {
    ...
    function run() external {
        ...
        /// The previous attempts failed with 1 hour expiry because the
        /// transaction took too long to mine. Use 48 hours instead.
        uint64 nonce = 7;
        ...
        console.log("Submitting transfer with 48h expiry...");
        console.log("nonce=%d intentId=%s", nonce, vm.toString(intentId));
        console.log("expiresAt=%d block.timestamp=%d", intent.expiresAt, block.timestamp);
